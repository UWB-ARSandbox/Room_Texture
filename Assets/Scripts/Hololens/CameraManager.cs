...
namespace UWB_Texturing {
    ...
    public static class CameraManager {
        ...
        static void OnStartPhotoMode(PhotoCapture.PhotoCaptureResult result)
        {
            ...
            TextManager.SetText(Messages.PhotoPrompt);
        }
        ...
        static void OnStoppedPhotoMode(PhotoCapture.PhotoCaptureResult result)
        {
            ...
            CustomMesh.SaveSupplementaryInfo(PositionArray, RotationArray);
        ...
        private static void SaveTexture()
        {
            ...
            File.WriteAllBytes(Path.Combine(FolderPath, CrossPlatformNames.Images.CompileFilename(currentPhoto)), texBytes);
